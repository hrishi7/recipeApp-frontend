...
export default class AddRecipe extends Component {
  constructor(props){
    ...
    this.state = {
      ...
      course: "default",
      recipeImage: null,
      recipeImageUrl:"https://i.ibb.co/8s8sYv7/food1.jpg",
      category:'default',
      source:"",
      servingSize:"",
      preperationTime:"",
  ...
  componentDidMount = () =>{
    ...
    if(item !== undefined){
      this.setState({
        ...
        recipeImageUrl:item.recipeImageUrl?item.title:"",
  ...
  render() {
    return (
      ...
      <Text style={{textAlign:'center'}}> AddRecipe </Text>
      <ScrollView>
      ...
      {this.state.recipeImageUrl === null ? (
        <Text>Add a Photo</Text>
          ...
          <TouchableOpacity
          style={{height:50,width:150, alignSelf:'center', marginHorizontal:5,marginVertical:5}}
